	...
	//if ((message.channel.id==auth.Salon.rueAgna) || (message.channel.id==auth.Salon.rueCaldera) || (message.channel.id==auth.Salon.rueBSS) || (message.channel.id==auth.Salon.rueOmashu))
		{
			...
			{
				message.reply("Sortant de nul part des cris de foule et de panique se font entendre dans diverses directions. Un nuage violet court sur une grande zone ; une horde d'esprit s'en prend à vous ! Coups ! Toux ! Désolations ! Vous vous sentez soudainement faible, démuni, comme privé de quelque chose dont vous n'auriez jamais pensé l'être... <br> coucou")
